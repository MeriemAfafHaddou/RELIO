...
with st.expander(
    ":blue[:question: How do we evaluate our solution on a real dataset?]",
    expanded=False,
):
    st.write("""
        We will test our solution on real datasets to assess its ability
        to detect different types of drift, while monitoring the
        performance of the supervised or unsupervised model.
    """)

st.write("""### Test :""")
# Dataset choice
option = st.selectbox(
    ":bar_chart: Which dataset would you like to pick ?", ("Ozone", "Asfault")
)
